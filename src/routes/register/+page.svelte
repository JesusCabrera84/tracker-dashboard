...
<div
	class="min-h-screen bg-gradient-to-br from-green-900 to-teal-900 flex items-center justify-center px-4"
>
	<div class="max-w-md w-full space-y-8">
		<div class="text-center">
			<h2 class="mt-6 text-3xl font-extrabold text-white">Crear Cuenta</h2>
			<p class="mt-2 text-sm text-green-200">Únete a Tracker Monitor</p>
		</div>
