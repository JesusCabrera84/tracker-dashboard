			...
			<div class="p-3 rounded-lg">
				...
				<div class="p-3 rounded-lg">
					...
					<div class="flex gap-2">
						<button class="btn-primary px-3 py-1 w-auto" on:click={setModern}> Moderno </button>
						<button class="btn-secondary" on:click={setClassic}> Clásico </button>
						<button class="btn-secondary" on:click={setDark}> Dark </button>
					</div>
				</div>
			</div>
		</div>
