	...
	<div class="menu-card">
		...
		<div class="controls">
			<div class="p-3 rounded-lg">
				<p class="text-sm font-medium mb-2 text-app">Configuraciiones</p>
